...
Companion application from source using CMake Presets. For platform-specific
environment setup (installing toolchains, Qt, etc.), see the platform guides
in this section.

!!! note
    The instructions here are meant to help you develop or test changes to
    EdgeTX on your PC, not to build flight/radio-safe versions of binaries.
...
For the full list, see [Compilation Options](compilation-options.md). For
radio-specific build flags (`PCB`, `PCBREV`) not covered above, refer to the
build scripts at
[https://github.com/EdgeTX/edgetx/tree/main/tools](https://github.com/EdgeTX/edgetx/tree/main/tools).
