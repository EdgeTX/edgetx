...
for i, (s, f) in enumerate([("Volt", "volt0"),
                            ...
                            ("Prozent", "percent0"),
                            ("Milliamperestunde", "mamph0"), ("Milliamperestunden", "mamph1"),
                            ("Watt", "watt0"),
                            ("Milliwatt", "mwatt0"),
                            ("D B", "db0"),
...
for i, s in enumerate(["Uhr", "Uhr", "Sender", "Empfang", "A1", "A2", "Höhe", "Motor",
                       "Treibstoff", "Temperatur", "Temperatur", "Geschwindigkeit", "Entfernung", "Höhe", "LiPo-Zelle",
                       "Zellen gesamt", "Spannung", "Strom", "Verbrauch", "Leistung", "Beschleunigung X", "Beschleunigung Y", "Beschleunigung Z",
