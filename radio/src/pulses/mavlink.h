...
extern const etx_proto_driver_t MavlinkDriver;

#define MAVLINK_BAUDRATE_COUNT 3
extern const uint32_t MAVLINK_BAUDRATES[MAVLINK_BAUDRATE_COUNT];

struct MavlinkModuleStatus {
  bool     linkUp;
