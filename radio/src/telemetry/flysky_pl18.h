...
#ifndef __FLYSKY_PL18_H__
#define __FLYSKY_PL18_H__
...
void flySkyPl18SetDefault(int index, uint8_t id, uint8_t subId, uint8_t instance);
void flySkyPl18ProcessTelemetryPacket(const uint8_t * ptr, uint8_t SensorType );
