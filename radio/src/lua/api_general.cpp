...
LROT_BEGIN(etxcst, NULL, 0)
  ...
  // Old style theme color constants - TODO: remove in 3.0
  ...
  // LROT_NUMENTRY( LIGHTRED, COLOR2FLAGS(COLOR_LIGHTRED_INDEX) )   // Add once above legacy entries are removed
  ...
  // LROT_NUMENTRY( CYAN, COLOR2FLAGS(COLOR_CYAN_INDEX) )           // Add once above legacy entries are removed
  ...
  // LROT_NUMENTRY( MAGENTA, COLOR2FLAGS(COLOR_MAGENTA_INDEX) )     // Add once above legacy entries are removed
