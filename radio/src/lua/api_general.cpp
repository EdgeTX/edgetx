...
// Virtual events
  ...
  { "EVT_VIRTUAL_MENU", EVT_KEY_BREAK(KEY_MENU) },
  { "EVT_VIRTUAL_MENU_LONG", EVT_KEY_LONG(KEY_MENU) },
  { "EVT_VIRTUAL_TELEM", EVT_KEY_BREAK(KEY_TELEM) },
  { "EVT_VIRTUAL_TELEM", EVT_KEY_LONG(KEY_TELEM) },
  { "EVT_VIRTUAL_INC", EVT_KEY_BREAK(KEY_PGDN) },
  { "EVT_VIRTUAL_DEC", EVT_KEY_BREAK(KEY_PGUP) },
#else
