...
const luaR_value_entry opentxConstants[] = {
  ...
  // Literal colors
  { "BLACK", COLOR2FLAGS(COLOR_BLACK_INDEX) },
  { "WHITE", COLOR2FLAGS(COLOR_WHITE_INDEX) },
  { "LIGHTWHITE", COLOR2FLAGS(COLOR_LIGHTWHITE_INDEX) },
  { "YELLOW", COLOR2FLAGS(COLOR_YELLOW_INDEX) },
  { "BLUE", COLOR2FLAGS(COLOR_BLUE_INDEX) },
  { "DARKBLUE", COLOR2FLAGS(COLOR_DARKBLUE_INDEX) },
  { "GREY", COLOR2FLAGS(COLOR_GREY_INDEX) },
  { "DARKGREY", COLOR2FLAGS(COLOR_DARKGREY_INDEX) },
  { "LIGHTGREY", COLOR2FLAGS(COLOR_LIGHTGREY_INDEX) },
  { "RED", COLOR2FLAGS(COLOR_RED_INDEX) },
  { "DARKRED", COLOR2FLAGS(COLOR_DARKRED_INDEX) },
  { "GREEN", COLOR2FLAGS(COLOR_GREEN_INDEX) },
  { "LIGHTBROWN", COLOR2FLAGS(COLOR_LIGHTBROWN_INDEX) },
  { "DARKBROWN", COLOR2FLAGS(COLOR_DARKBROWN_INDEX) },
  { "BRIGHTGREEN", COLOR2FLAGS(COLOR_BRIGHTGREEN_INDEX) },
  { "ORANGE", COLOR2FLAGS(COLOR_ORANGE_INDEX) },
#else
