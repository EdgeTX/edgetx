...
STRLIST(STR_SUBTYPE_AFHDS2A,   {"PWM,IBUS","PPM,IBUS","PWM,SBUS","PPM,SBUS","PWM,IB16","PPM,IB16"})
...
STRLIST(STR_SUBTYPE_V761,      {"3ch","4ch"})
...
STRLIST(STR_SUBTYPE_FRSKYR9,   {"915MHz","868MHz","915 8ch","868 8ch","FCC","---","FCC 8ch"})
...
PROTODEF {
  ...
  {MODULE_SUBTYPE_MULTI_DSM_RX,     1, false, false,  STR_SUBTYPE_RX,        nullptr}, //new
