...
const char STR_WARN_MPM_LOWPOWER[]  = TR_WARN_MPM_LOWPOWER;
...
const char STR_FLASH_INTERNAL_MPM[]  = TR_FLASH_INTERNAL_MPM;
const char STR_FLASH_EXTERNAL_MODULE[] = TR_FLASH_EXTERNAL_MODULE;
const char STR_FLASH_EXTERNAL_MPM[]  = TR_FLASH_EXTERNAL_MPM;
...
const char STR_MPM_RFTUNE[] = TR_MPM_RFTUNE;
const char STR_MPM_RFPOWER[]  = TR_MPM_RFPOWER;
const char STR_MPM_WBUS[]  = TR_MPM_WBUS;
const char STR_MPM_TELEMETRY[] = TR_MPM_TELEMETRY;
const char STR_MPM_VIDFREQ[] = TR_MPM_VIDFREQ;
const char STR_MPM_OPTION[] = TR_MPM_OPTION;
const char STR_MPM_FIXEDID[] = TR_MPM_FIXEDID;
const char STR_MPM_AUTOBIND[] = TR_MPM_AUTOBIND;
const char STR_DISABLE_CH_MAP[]  = TR_DISABLE_CH_MAP;
const char STR_DISABLE_TELEM[]  = TR_DISABLE_TELEM;
const char STR_MPM_DSM_AUTODTECT[] = TR_MPM_DSM_AUTODTECT;
const char STR_MPM_LOWPOWER[] = TR_MPM_LOWPOWER;
const char STR_MPM_LNA_DISABLE[]  = TR_MPM_LNA_DISABLE;
...
const char STR_MPM_SERVOFREQ[] = TR_MPM_SERVOFREQ;
const char STR_MPM_MAX_THROW[] = TR_MPM_MAX_THROW;
const char STR_MPM_RFCHAN[] = TR_MPM_RFCHAN;
const char STR_NEEDS_FILE[]  = TR_NEEDS_FILE;
const char STR_EXT_MPM_SPEC[] = TR_EXT_MPM_SPEC;
const char STR_INT_MPM_SPEC[] = TR_INT_MPM_SPEC;
