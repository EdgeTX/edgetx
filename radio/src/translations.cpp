...
const char STR_ONE_LOG_PER_DAY[] = TR_ONE_LOG_PER_DAY;
...
const char STR_IBUS2_SENSORS_MODE_ONLY[] = TR_IBUS2_SENSORS_MODE_ONLY;
...
#if defined(DSMP)
const char STR_DSMP_ENABLE_AETR[] = TR_DSMP_ENABLE_AETR;
#endif
