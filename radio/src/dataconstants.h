...
enum MixSources {
  ...
  MIXSRC_SPACEMOUSE_A = MIXSRC_FIRST_SPACEMOUSE, LUA_EXPORT("sm-a", "SpaceMouse A")
  MIXSRC_SPACEMOUSE_B, LUA_EXPORT("sm-b", "SpaceMouse B")
  MIXSRC_SPACEMOUSE_C, LUA_EXPORT("sm-c", "SpaceMouse C")
  MIXSRC_SPACEMOUSE_D, LUA_EXPORT("sm-d", "SpaceMouse D")
  MIXSRC_SPACEMOUSE_E, LUA_EXPORT("sm-e", "SpaceMouse E")
  MIXSRC_SPACEMOUSE_F, LUA_EXPORT("sm-f", "SpaceMouse F")
