...
bool isInternalModuleSupported(int moduleType)
{
  ...
  case MODULE_TYPE_MPM: return true;
#endif
...
#if !defined(MPM)
  if (protocol == PROTOCOL_TELEMETRY_SPEKTRUM || protocol == PROTOCOL_TELEMETRY_FLYSKY_IBUS || protocol == PROTOCOL_TELEMETRY_MPM) {
    return false;
  }
#endif
...
// This maps EdgeTX multi type with Pascal's multi type
uint8_t multiConvertOtxToMulti(uint8_t moduleIdx, uint8_t type)
{
  ...
  if (type == MODULE_SUBTYPE_MPM_FRSKY) {
...
{
  if  (type == 3) //FrSkyD
    return MODULE_SUBTYPE_MPM_FRSKY;
...
// Protocol as defined in pulses\modules_constants.h, number of sub_protocols - 1, Failsafe supported, Disable channel mapping supported, Subtype string, Option type
  {MODULE_SUBTYPE_MPM_FLYSKY,     4, false, true,   STR_SUBTYPE_FLYSKY,    nullptr},
  {MODULE_SUBTYPE_MPM_HUBSAN,     2, false, false,  STR_SUBTYPE_HUBSAN,    STR_MPM_VIDFREQ},
  {MODULE_SUBTYPE_MPM_FRSKY,      7, false, false,  STR_SUBTYPE_FRSKY,     STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_HISKY,      1, false, true,   STR_SUBTYPE_HISKY,     nullptr},
  {MODULE_SUBTYPE_MPM_V2X2,       2, false, false,  STR_SUBTYPE_V2X2,      nullptr},
  {MODULE_SUBTYPE_MPM_DSM2,       5, false, true,   STR_SUBTYPE_DSM,       STR_MPM_MAX_THROW},
  {MODULE_SUBTYPE_MPM_DEVO,       4, false, true,   STR_SUBTYPE_DEVO,      STR_MPM_FIXEDID},
  {MODULE_SUBTYPE_MPM_YD717,      4, false, false,  STR_SUBTYPE_YD717,     nullptr},
  {MODULE_SUBTYPE_MPM_KN,         1, false, false,  STR_SUBTYPE_KN,        nullptr},
  {MODULE_SUBTYPE_MPM_SYMAX,      1, false, false,  STR_SUBTYPE_SYMAX,     nullptr},
  {MODULE_SUBTYPE_MPM_SLT,        4, false, true,   STR_SUBTYPE_SLT,       STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_CX10,       6, false, false,  STR_SUBTYPE_CX10,      nullptr},
  {MODULE_SUBTYPE_MPM_CG023,      1, false, false,  STR_SUBTYPE_CG023,     nullptr},
  {MODULE_SUBTYPE_MPM_BAYANG,     5, false, false,  STR_SUBTYPE_BAYANG,    STR_MPM_TELEMETRY},
  {MODULE_SUBTYPE_MPM_ESky,       1, false, true,   STR_SUBTYPE_ESky,      nullptr},
  {MODULE_SUBTYPE_MPM_MT99XX,     4, false, false,  STR_SUBTYPE_MT99,      nullptr},
  {MODULE_SUBTYPE_MPM_MJXQ,       6, false, false,  STR_SUBTYPE_MJXQ,      STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_FY326,      1, false, false,  STR_SUBTYPE_FY326,     nullptr},
  {MODULE_SUBTYPE_MPM_FUTABA,     0, true,  true,   STR_SUBTYPE_FUTABA,    STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_J6PRO,      0, false, true,   NO_SUBTYPE,            nullptr},
  {MODULE_SUBTYPE_MPM_HONTAI,     3, false, false,  STR_SUBTYPE_HONTAI,    nullptr},
  {MODULE_SUBTYPE_MPM_OLRS,       0, false, false,  NO_SUBTYPE,            STR_RF_POWER},
  {MODULE_SUBTYPE_MPM_FS_AFHDS2A, 5, true,  true,   STR_SUBTYPE_AFHDS2A,   STR_MPM_SERVOFREQ},
  {MODULE_SUBTYPE_MPM_Q2X2,       2, false, false,  STR_SUBTYPE_Q2X2,      nullptr},
  {MODULE_SUBTYPE_MPM_WK_2X01,    5, false, true,   STR_SUBTYPE_WK2x01,    nullptr},
  {MODULE_SUBTYPE_MPM_Q303,       3, false, false,  STR_SUBTYPE_Q303,      nullptr},
  {MODULE_SUBTYPE_MPM_CABELL,     7, false, false,  STR_SUBTYPE_CABELL,    STR_MPM_OPTION},
  {MODULE_SUBTYPE_MPM_ESKY150,    1, false, false,  STR_SUBTYPE_ESKY150,   nullptr},
  {MODULE_SUBTYPE_MPM_H83D,       3, false, false,  STR_SUBTYPE_H83D,      nullptr},
  {MODULE_SUBTYPE_MPM_CORONA,     2, false, false,  STR_SUBTYPE_CORONA,    STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_HITEC,      2, false, false,  STR_SUBTYPE_HITEC,     STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_WFLY,       0, false, false,  STR_SUBTYPE_WFLY,      nullptr},
  {MODULE_SUBTYPE_MPM_BUGS_MINI,  1, false, false,  STR_SUBTYPE_BUGS_MINI, nullptr},
  {MODULE_SUBTYPE_MPM_TRAXXAS,    0, false, false,  STR_SUBTYPE_TRAXXAS,   nullptr},
  {MODULE_SUBTYPE_MPM_E01X,       2, false, false,  STR_SUBTYPE_E01X,      STR_MPM_OPTION},
  {MODULE_SUBTYPE_MPM_V911S,      1, false, false,  STR_SUBTYPE_V911S,     STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_GD00X,      1, false, false,  STR_SUBTYPE_GD00X,     STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_V761,       1, false, false,  STR_SUBTYPE_V761,      nullptr},
  {MODULE_SUBTYPE_MPM_KF606,      0, false, false,  NO_SUBTYPE,            STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_REDPINE,    1, false, false,  STR_SUBTYPE_REDPINE,   STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_POTENSIC,   0, false, false,  STR_SUBTYPE_POTENSIC,  nullptr},
  {MODULE_SUBTYPE_MPM_ZSX,        0, false, false,  STR_SUBTYPE_ZSX,       nullptr},
  {MODULE_SUBTYPE_MPM_HEIGHT,     1, false, false,  STR_SUBTYPE_HEIGHT,    nullptr},
  {MODULE_SUBTYPE_MPM_FRSKYX_RX,  1, false, false,  STR_SUBTYPE_FRSKYX_RX, STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_HOTT,       1, true,  false,  STR_SUBTYPE_HOTT,      STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_FX816,      0, false, false,  STR_SUBTYPE_FX816,     nullptr},
  {MODULE_SUBTYPE_MPM_PELIKAN,    1, false, true,   STR_SUBTYPE_PELIKAN,   nullptr},
  {MODULE_SUBTYPE_MPM_XK,         1, false, false,  STR_SUBTYPE_XK,        STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_XN297DUMP,  4, false, false,  STR_SUBTYPE_XN297DUMP, STR_MPM_RFCHAN},
  {MODULE_SUBTYPE_MPM_FRSKYX2,    5, true,  false,  STR_SUBTYPE_FRSKYX2,   STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_FRSKY_R9,   6, true,  false,  STR_SUBTYPE_FRSKYR9,   nullptr},
  {MODULE_SUBTYPE_MPM_PROPEL,     0, false, false,  STR_SUBTYPE_PROPEL,    nullptr},
  {MODULE_SUBTYPE_MPM_FRSKYL,     1, false, false,  STR_SUBTYPE_FRSKYL,    STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_SKYARTEC,   0, false, false,  NO_SUBTYPE,            STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_ESKY150V2,  0, false, true,   STR_SUBTYPE_ESKY150V2, STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_JJRC345,    1, false, false,  STR_SUBTYPE_JJRC345,   nullptr},
  {MODULE_SUBTYPE_MPM_Q90C,       0, false, false,  NO_SUBTYPE,            STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_KYOSHO,     1, false, true,   STR_SUBTYPE_KYOSHO,    nullptr},
  {MODULE_SUBTYPE_MPM_RLINK,      2, false, false,  STR_SUBTYPE_RLINK,     STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_ELRS,       0, false, false,  STR_SUBTYPE_ELRS,      nullptr},
  {MODULE_SUBTYPE_MPM_REALACC,    0, false, false,  STR_SUBTYPE_REALACC,   nullptr},
  {MODULE_SUBTYPE_MPM_OMP,        0, false, false,  NO_SUBTYPE,            STR_MPM_RFTUNE},
  {MODULE_SUBTYPE_MPM_WFLY2,      0, false, false,  STR_SUBTYPE_WFLY2,     STR_MPM_OPTION},
  {MODULE_SUBTYPE_MPM_E016HV2,    0, false, false,  NO_SUBTYPE,            STR_MPM_RFTUNE},
  {MM_RF_CUSTOM_SELECTED,           7, true,  true,   NO_SUBTYPE,            STR_MPM_OPTION},
