...
void menuModelFlightModeOne(event_t event)
{
  ...
  static const uint8_t mstate_tab_fm1[]  = {0, 3, (uint8_t)max(0, keysGetMaxTrims() - 5), 0, 0, (uint8_t)-1, 1, 1, 1, 1, 1, 1};
  static const uint8_t mstate_tab_others[]  = {0, 0, 3, (uint8_t)max(0, keysGetMaxTrims() - 5), 0, 0,(uint8_t)-1, 2, 2, 2, 2, 2};
