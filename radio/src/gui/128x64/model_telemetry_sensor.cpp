...
//         break;
      ...
      case SENSOR_FIELD_PARAM1:
        if (sensor->type == TELEM_TYPE_CALCULATED) {
          if (sensor->formula == TELEM_FORMULA_CELL) {
            ...
            drawSource(SENSOR_2ND_COLUMN, y, sensor->cell.source ? SourceRef{SOURCE_TYPE_TELEMETRY, 0, (uint16_t)(3*(sensor->cell.source-1))} : SourceRef{}, attr);
            if (attr) {
            ...
            drawSource(SENSOR_2ND_COLUMN, y, sensor->dist.gps ? SourceRef{SOURCE_TYPE_TELEMETRY, 0, (uint16_t)(3*(sensor->dist.gps-1))} : SourceRef{}, attr);
            if (attr) {
            ...
            drawSource(SENSOR_2ND_COLUMN, y, sensor->consumption.source ? SourceRef{SOURCE_TYPE_TELEMETRY, 0, (uint16_t)(3*(sensor->consumption.source-1))} : SourceRef{}, attr);
            if (attr) {
      ...
      case SENSOR_FIELD_PARAM2:
        if (sensor->type == TELEM_TYPE_CALCULATED) {
          if (sensor->formula == TELEM_FORMULA_CELL) {
            ...
            drawSource(SENSOR_2ND_COLUMN, y, sensor->dist.alt ? SourceRef{SOURCE_TYPE_TELEMETRY, 0, (uint16_t)(3*(sensor->dist.alt-1))} : SourceRef{}, attr);
            if (attr) {
      ...
      case SENSOR_FIELD_PARAM4:
      {
        ...
        if (*source < 0) {
          lcdDrawChar(SENSOR_2ND_COLUMN, y, '-', attr);
          drawSource(lcdNextPos, y, {SOURCE_TYPE_TELEMETRY, 0, (uint16_t)(3*(-1-*source))}, attr);
        }
        else {
          drawSource(SENSOR_2ND_COLUMN, y, *source ? SourceRef{SOURCE_TYPE_TELEMETRY, 0, (uint16_t)(3*(*source-1))} : SourceRef{}, attr);
        }
        break;
      }
