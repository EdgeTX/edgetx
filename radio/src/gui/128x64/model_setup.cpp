  ...
  for (uint8_t i=0; i<NUM_BODY_LINES; ++i) {
    ...
    switch (k) {
      ...
      case ITEM_MODEL_SETUP_CUSTOM_THROTTLE_WARNING:
        g_model.enableCustomThrottleWarning = editCheckBox(g_model.enableCustomThrottleWarning, MODEL_SETUP_2ND_COLUMN, y, "\001C-War-En", attr, event);
        break;

      case ITEM_MODEL_SETUP_CUSTOM_THROTTLE_WARNING_VALUE:
        {
          lcdDrawText(INDENT_WIDTH, y, "C-War-Pos%");
