...
PageDef modelMenuItems[] = {
  ...
  { ICON_MODEL_FLIGHT_MODES, STR_QM_FLIGHT_MODES, STR_MENUFLIGHTMODES, PAGE_CREATE, QuickMenu::MODEL_FLIGHTMODES, [](PageDef& pageDef) { return new ModelFlightModesPage(pageDef); }, modelFMEnabled},
#endif
  { ICON_MODEL_INPUTS, STR_QM_INPUTS, STR_MENUINPUTS, PAGE_CREATE, QuickMenu::MODEL_INPUTS, [](PageDef& pageDef) { return new ModelInputsPage(pageDef); }},
  { ICON_MODEL_MIXER, STR_QM_MIXES, STR_MIXES, PAGE_CREATE, QuickMenu::MODEL_MIXES, [](PageDef& pageDef) { return new ModelMixesPage(pageDef); }},
  { ICON_MODEL_OUTPUTS, STR_QM_OUTPUTS, STR_MENULIMITS, PAGE_CREATE, QuickMenu::MODEL_OUTPUTS, [](PageDef& pageDef) { return new ModelOutputsPage(pageDef); }},
  { ICON_MODEL_CURVES, STR_QM_CURVES, STR_MENUCURVES, PAGE_CREATE, QuickMenu::MODEL_CURVES, [](PageDef& pageDef) { return new ModelCurvesPage(pageDef); }, modelCurvesEnabled},
#if defined(GVARS)
