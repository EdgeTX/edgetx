...
enum LcdColorIndex
{
  ...
  OS_COLOR_PRIMARY1_INDEX,
  OS_COLOR_PRIMARY2_INDEX,
  OS_COLOR_PRIMARY3_INDEX,
  OS_COLOR_SECONDARY1_INDEX,
  OS_COLOR_SECONDARY2_INDEX,
  OS_COLOR_SECONDARY3_INDEX,
  OS_COLOR_FOCUS_INDEX,
  OS_COLOR_EDIT_INDEX,
  OS_COLOR_ACTIVE_INDEX,
  OS_COLOR_WARNING_INDEX,
  ...
  LINE_COLOR_INDEX,
  MENU_HIGHLIGHT_BGCOLOR_INDEX,
  MAINVIEW_GRAPHICS_COLOR_INDEX,
  MAINVIEW_PANES_COLOR_INDEX,
  MENU_BGCOLOR_INDEX,
  MENU_COLOR_INDEX,
  MENU_HIGHLIGHT_COLOR_INDEX,
  MENU_LINE_COLOR_INDEX,
...
//#define MENU_HIGHLIGHT_COLOR_INDEX     HIGHLIGHT_COLOR_INDEX
//#define MENU_LINE_COLOR_INDEX          LINE_COLOR_INDEX
...
#define OS_COLOR_PRIMARY1              COLOR(OS_COLOR_PRIMARY1_INDEX)
#define OS_COLOR_PRIMARY2              COLOR(OS_COLOR_PRIMARY2_INDEX)
#define OS_COLOR_PRIMARY3              COLOR(OS_COLOR_PRIMARY3_INDEX)
#define OS_COLOR_SECONDARY1            COLOR(OS_COLOR_SECONDARY1_INDEX)
#define OS_COLOR_SECONDARY2            COLOR(OS_COLOR_SECONDARY2_INDEX)
#define OS_COLOR_SECONDARY3            COLOR(OS_COLOR_SECONDARY3_INDEX)
#define OS_COLOR_FOCUS                 COLOR(OS_COLOR_FOCUS_INDEX)
#define OS_COLOR_EDIT                  COLOR(OS_COLOR_EDIT_INDEX)
#define OS_COLOR_ACTIVE                COLOR(OS_COLOR_ACTIVE_INDEX)
#define OS_COLOR_WARNING               COLOR(OS_COLOR_WARNING_INDEX)
...
#define EDIT_MARKER_COLOR              COLOR(EDIT_MARKER_COLOR_INDEX)
#define FIELD_BGCOLOR                  COLOR(FIELD_BGCOLOR_INDEX)
#define FIELD_FRAME_COLOR              COLOR(FIELD_FRAME_COLOR_INDEX)
