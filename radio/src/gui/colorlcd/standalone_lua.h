...
public:
  ...
  static LAYOUT_VAL(ERR_TTL_X, 50, 50, LS(50))
  static LAYOUT_VAL(ERR_TTL_Y, 30, 30, LS(30))
  static LAYOUT_VAL(ERR_MSG_Y, 62, 62, LS(62))
  static LAYOUT_VAL(ERR_MSG_HO, 92, 92, LS(92))
