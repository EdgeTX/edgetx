...
LAYOUT_VAL2(FOOTER_X1, LCD_W / 4, LCD_W / 2)
LAYOUT_VAL2(FOOTER_X2, LCD_W * 3 / 4, LCD_W / 2)
LAYOUT_VAL(FOOTER_Y1, 30, 30, LS(30))
LAYOUT_VAL(FOOTER_Y2, 30, 58, LS(30))
LAYOUT_VAL(FOOTER_LY, 38, 62, LS(38))
...
LAYOUT_VAL(SYM_X, 102, 70, LS(102))
LAYOUT_VAL(LBL_X, 124, 92, LS(124))
...
LAYOUT_VAL(OPTBOX_X, 92, 60, LS(92))

LAYOUT_VAL(USB_ICN_X, 60, 105, LS(60))
LAYOUT_VAL(USB_ICN_Y, 106, 185, LS(106))
LAYOUT_VAL(USB_TXT_X, 195, 160, LS(195))
LAYOUT_VAL(USB_TXT_Y1, 97, 125, LS(97))
LAYOUT_VAL(USB_TXT_Y2, 72, 100, LS(72))
LAYOUT_VAL2(USB_TXT_ALIGN, 0, CENTERED)

LAYOUT_VAL(USB_PLG_X, 136, 134, LS(136))
LAYOUT_VAL(USB_PLG_TXT_YO, 30, 58, LS(30))

LAYOUT_VAL(FILENAM_X1, 94, 60, LS(94))
LAYOUT_VAL(FILENAM_X2, 124, 90, LS(124))
LAYOUT_VAL(FILENAM_Y1, 75, 75, LS(75))
LAYOUT_VAL(FILENAM_H, 25, 25, LS(25))
LAYOUT_VAL(FILESEL_X, 119, 85, LS(119))
LAYOUT_VAL(FILESEL_W, 278, 185, LS(278))

LAYOUT_VAL(VERCHK_X, 168, 112, LS(168))
LAYOUT_VAL(VERCHK_Y, 138, 240, LS(138))
LAYOUT_VAL(VERCHK_ICN_X, 78, 22, LS(78))
