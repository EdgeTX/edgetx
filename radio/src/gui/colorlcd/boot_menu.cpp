...
LAYOUT_ORIENTATION_SCALED(SYM_X, 102, 70)
LAYOUT_ORIENTATION_SCALED(LBL_X, 124, 92)
LAYOUT_VAL_SCALED(SYM_Y, 75)
LAYOUT_VAL_SCALED(SYM_H, 35)

LAYOUT_VAL_SCALED(BOX_GAP, 8)
LAYOUT_VAL_SCALED(BOX_Y, 72)
LAYOUT_VAL_SCALED(BOX_H, 26)

LAYOUT_ORIENTATION_SCALED(OPTBOX_X, 92, 60)
...
LAYOUT_ORIENTATION_SCALED(FILENAM_X1, 94, 60)
LAYOUT_ORIENTATION_SCALED(FILENAM_X2, 124, 90)
LAYOUT_VAL_SCALED(FILENAM_Y1, 75)
LAYOUT_VAL_SCALED(FILENAM_H, 25)
LAYOUT_ORIENTATION_SCALED(FILESEL_X, 119, 85)
LAYOUT_ORIENTATION_SCALED(FILESEL_W, 278, 185)
