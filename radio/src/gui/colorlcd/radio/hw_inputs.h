...
struct HWPots : public Window
{
 public:
  ...
  static LAYOUT_VAL(P_NM_X, P_LBL_X + P_LBL_W + PAD_MEDIUM, 100, P_LBL_X + P_LBL_W + PAD_MEDIUM);
  static LAYOUT_VAL(P_NM_W, 70, 70, LS(70))
  static LAYOUT_VAL(P_TYP_X, P_NM_X + P_NM_W, 32, P_NM_X + P_NM_W)
  static LAYOUT_VAL(P_TYP_W, 160, P_LBL_W, LS(160))
  static LAYOUT_VAL(P_INV_X, P_TYP_X + P_TYP_W + PAD_MEDIUM, P_NM_X + P_NM_W + PAD_MEDIUM, P_TYP_X + P_TYP_W + PAD_MEDIUM)
