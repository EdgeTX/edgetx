...
struct HWPots : public Window
{
 public:
  ...
  static LAYOUT_VAL3(P_LBL_W, (DIALOG_DEFAULT_WIDTH - 45) * 2 / 11, (DIALOG_DEFAULT_WIDTH - 18) * 13 / 21, (DIALOG_DEFAULT_WIDTH - 30) * 2 / 11, (DIALOG_DEFAULT_WIDTH - 67) * 2 / 11)
  static LAYOUT_VAL2(P_NM_X, P_LBL_X + P_LBL_W + PAD_MEDIUM, 100);
  static LAYOUT_VAL(P_NM_W, 70, 70, LS(70))
  static LAYOUT_VAL2(P_TYP_X, P_NM_X + P_NM_W, 32)
  static LAYOUT_VAL(P_TYP_W, 160, P_LBL_W, LS(160))
  static LAYOUT_VAL2(P_INV_X, P_TYP_X + P_TYP_W + PAD_MEDIUM, P_NM_X + P_NM_W + PAD_MEDIUM)
