...
static const struct YamlNode struct_FrSkyLineData[] = {
  YAML_IDX,
  YAML_ARRAY("sources", 32, 2, struct_LineDataSource, NULL),
  YAML_END
};
...
static const struct YamlNode union_TelemetryScreenData_u_elmts[] = {
  ...
  YAML_ARRAY("lines", 64, 4, struct_FrSkyLineData, NULL),
...
static const struct YamlNode struct_TelemetryScreenData[] = {
  ...
  YAML_UNION("u", 256, union_TelemetryScreenData_u_elmts, select_tele_screen_data),
  YAML_END
};
...
static const struct YamlNode struct_ModelData[] = {
  ...
  YAML_EXTERN_ARRAY("flightModeData", 192, MAX_FLIGHT_MODES, struct_FlightModeData, yaml_get_fmd_ptr, yaml_ensure_fmd_capacity),
