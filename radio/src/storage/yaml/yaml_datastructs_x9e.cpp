...
static const struct YamlNode union_anonymous_22_elmts[] = {
  YAML_UNSIGNED( "id", 16 ),
...
static const struct YamlNode union_anonymous_23_elmts[] = {
  YAML_STRUCT("", 8, struct_anonymous_24, NULL),
  YAML_STRUCT("frskyInstance", 8, struct_anonymous_25, NULL),
...
static const struct YamlNode union_anonymous_26_elmts[] = {
  YAML_STRUCT("", 32, struct_anonymous_27, NULL),
  YAML_STRUCT("custom", 32, struct_anonymous_28, NULL),
  YAML_STRUCT("", 32, struct_anonymous_29, NULL),
  YAML_STRUCT("cell", 32, struct_anonymous_30, NULL),
  YAML_STRUCT("", 32, struct_anonymous_31, NULL),
  YAML_STRUCT("calc", 32, struct_anonymous_32, NULL),
  YAML_STRUCT("", 32, struct_anonymous_33, NULL),
  YAML_STRUCT("consumption", 32, struct_anonymous_34, NULL),
  YAML_STRUCT("", 32, struct_anonymous_35, NULL),
  YAML_STRUCT("dist", 32, struct_anonymous_36, NULL),
  YAML_UNSIGNED( "param", 32 ),
  YAML_END
};
static const struct YamlNode struct_TelemetrySensor[] = {
  YAML_IDX,
  YAML_UNION("id1", 16, union_anonymous_22_elmts, select_id1),
  YAML_UNION("id2", 8, union_anonymous_23_elmts, select_id2),
  YAML_STRING("label", 4),
  ...
  YAML_PADDING( 1 ),
  YAML_UNION("cfg", 32, union_anonymous_26_elmts, select_sensor_cfg),
  YAML_END
};
