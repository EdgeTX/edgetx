...
static const struct YamlNode struct_SwitchRef[] = {
  YAML_UNSIGNED( "type", 8 ),
  YAML_UNSIGNED( "flags", 8 ),
  YAML_UNSIGNED( "index", 16 ),
  YAML_END
};
...
static const struct YamlNode struct_SourceRef[] = {
  YAML_UNSIGNED( "type", 8 ),
  YAML_UNSIGNED( "flags", 8 ),
  YAML_UNSIGNED( "index", 16 ),
  YAML_END
...
static const struct YamlNode struct_anonymous_2[] = {
  YAML_UNION("val", 32, union_LSValue_elmts, NULL),
...
static const struct YamlNode union_anonymous_0_elmts[] = {
  ...
  YAML_STRUCT("all", 80, struct_anonymous_2, NULL),
...
static const struct YamlNode struct_RadioData[] = {
  ...
  YAML_EXTERN_ARRAY("customFn", 128, MAX_SPECIAL_FUNCTIONS_HARD, struct_CustomFunctionData, yaml_get_radio_cfn_ptr, yaml_ensure_radio_cfn_capacity),
...
static const struct YamlNode struct_LimitData[] = {
  ...
  YAML_SIGNED_CUST( "max", 16, in_read_weight, in_write_weight ),
  YAML_SIGNED_CUST( "offset", 16, in_read_weight, in_write_weight ),
  YAML_SIGNED( "ppmCenter", 12 ),
...
static const struct YamlNode struct_ExpoData[] = {
  ...
  YAML_UNSIGNED( "chn", 5 ),
  YAML_UNSIGNED( "scale", 16 ),
  YAML_CUSTOM("carryTrim",r_carryTrim,nullptr),
  YAML_SIGNED( "trimSource", 8 ),
  YAML_STRING("name", 6),
  YAML_END
};
...
static const struct YamlNode union_anonymous_4_elmts[] = {
  ...
  YAML_STRUCT("crsf", 40, struct_anonymous_12, NULL),
...
static const struct YamlNode union_ScriptDataInput[] = {
  YAML_IDX,
  YAML_UNION("u", 32, union_ScriptDataInput_elmts, select_script_input),
  YAML_END
};
...
static const struct YamlNode struct_LineDataSource[] = {
  YAML_IDX,
  YAML_UNSIGNED_CUST( "val", 32, r_sourceRef, w_sourceRef ),
  YAML_END
};
static const struct YamlNode struct_FrSkyLineData[] = {
  YAML_IDX,
  YAML_ARRAY("sources", 32, 3, struct_LineDataSource, NULL),
  YAML_END
};
...
static const struct YamlNode union_TelemetryScreenData_u_elmts[] = {
  YAML_ARRAY("bars", 64, 4, struct_FrSkyBarData, NULL),
  YAML_ARRAY("lines", 96, 4, struct_FrSkyLineData, NULL),
...
static const struct YamlNode struct_TelemetryScreenData[] = {
  ...
  YAML_UNION("u", 384, union_TelemetryScreenData_u_elmts, select_tele_screen_data),
  YAML_END
};
...
static const struct YamlNode struct_ModelData[] = {
  ...
  YAML_ARRAY("timers", 160, 3, struct_TimerData, NULL),
  ...
  YAML_ARRAY("limitData", 120, 32, struct_LimitData, NULL),
  YAML_EXTERN_ARRAY("expoData", 264, MAX_EXPOS_HARD, struct_ExpoData, yaml_get_expo_ptr, yaml_ensure_expo_capacity),
  YAML_EXTERN_ARRAY("curves", 32, MAX_CURVES_HARD, struct_CurveHeader, yaml_get_curves_ptr, yaml_ensure_curves_capacity),
  YAML_EXTERN_ARRAY("points", 8, MAX_CURVE_POINTS_HARD, struct_signed_8, yaml_get_points_ptr, yaml_ensure_points_capacity),
  YAML_EXTERN_ARRAY("logicalSw", 144, MAX_LOGICAL_SWITCHES_HARD, struct_LogicalSwitchData, yaml_get_logical_sw_ptr, yaml_ensure_logical_sw_capacity),
  YAML_EXTERN_ARRAY("customFn", 128, MAX_SPECIAL_FUNCTIONS_HARD, struct_CustomFunctionData, yaml_get_custom_fn_ptr, yaml_ensure_custom_fn_capacity),
  YAML_STRUCT("swashR", 136, struct_SwashRingData, swash_is_active),
  YAML_EXTERN_ARRAY("flightModeData", 224, MAX_FLIGHT_MODES, struct_FlightModeData, yaml_get_fmd_ptr, yaml_ensure_fmd_capacity),
  ...
  YAML_EXTERN_ARRAY("gvars", 56, MAX_GVARS, struct_GVarData, yaml_get_gvar_data_ptr, yaml_ensure_gvar_data_capacity),
  YAML_EXTERN_ARRAY("gvarValues", 16, MAX_FLIGHT_MODES * MAX_GVARS, struct_signed_16, yaml_get_gvar_values_ptr, yaml_ensure_gvar_values_capacity),
  ...
  YAML_ARRAY("scriptsData", 288, 7, struct_ScriptData, NULL),
  ...
  YAML_PADDING( 8 ),
  YAML_ARRAY("screens", 384, 4, struct_TelemetryScreenData, NULL),
  YAML_UNSIGNED( "view", 8 ),
