...
static const struct YamlNode union_anonymous_0_elmts[] = {
  YAML_STRUCT("", 64, struct_anonymous_1, NULL),
  YAML_STRUCT("play", 64, struct_anonymous_2, NULL),
  YAML_STRUCT("", 64, struct_anonymous_3, NULL),
  YAML_STRUCT("all", 64, struct_anonymous_4, NULL),
  YAML_STRUCT("", 64, struct_anonymous_5, NULL),
  YAML_STRUCT("clear", 64, struct_anonymous_6, NULL),
  YAML_END
};
...
static const struct YamlNode struct_anonymous_24[] = {
  YAML_UNSIGNED( "flags", 8 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_25[] = {
  YAML_UNSIGNED( "flags", 8 ),
  YAML_END
};
static const struct YamlNode union_anonymous_7_elmts[] = {
  ...
  YAML_STRUCT("", 24, struct_anonymous_8, NULL),
  YAML_STRUCT("multi", 24, struct_anonymous_9, NULL),
  YAML_STRUCT("", 16, struct_anonymous_10, NULL),
  YAML_STRUCT("pxx", 16, struct_anonymous_11, NULL),
  YAML_STRUCT("", 16, struct_anonymous_12, NULL),
  YAML_STRUCT("sbus", 16, struct_anonymous_13, NULL),
  YAML_STRUCT("", 200, struct_anonymous_14, NULL),
  YAML_STRUCT("pxx2", 200, struct_anonymous_15, NULL),
  YAML_STRUCT("", 56, struct_anonymous_16, NULL),
  YAML_STRUCT("flysky", 56, struct_anonymous_17, NULL),
  YAML_STRUCT("", 8, struct_anonymous_18, NULL),
  YAML_STRUCT("afhds3", 8, struct_anonymous_19, NULL),
  YAML_STRUCT("", 8, struct_anonymous_20, NULL),
  YAML_STRUCT("ghost", 8, struct_anonymous_21, NULL),
  YAML_STRUCT("", 8, struct_anonymous_22, NULL),
  YAML_STRUCT("crsf", 8, struct_anonymous_23, NULL),
  YAML_STRUCT("", 8, struct_anonymous_24, NULL),
  YAML_STRUCT("dsmp", 8, struct_anonymous_25, NULL),
  YAML_END
};
...
static const struct YamlNode union_anonymous_26_elmts[] = {
  YAML_UNSIGNED( "id", 16 ),
  YAML_UNSIGNED( "persistentValue", 16 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_28[] = {
  YAML_UNSIGNED( "physID", 5 ),
  YAML_UNSIGNED( "rxIndex", 3 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_29[] = {
  YAML_UNSIGNED( "physID", 5 ),
  YAML_UNSIGNED( "rxIndex", 3 ),
  YAML_END
};
static const struct YamlNode union_anonymous_27_elmts[] = {
  YAML_STRUCT("", 8, struct_anonymous_28, NULL),
  YAML_STRUCT("frskyInstance", 8, struct_anonymous_29, NULL),
  YAML_UNSIGNED( "instance", 8 ),
  YAML_ENUM("formula", 8, enum_TelemetrySensorFormula),
  YAML_END
};
static const struct YamlNode struct_anonymous_31[] = {
  YAML_UNSIGNED( "ratio", 16 ),
  YAML_SIGNED( "offset", 16 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_32[] = {
  YAML_UNSIGNED( "ratio", 16 ),
  YAML_SIGNED( "offset", 16 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_33[] = {
  YAML_UNSIGNED( "source", 8 ),
  YAML_UNSIGNED( "index", 8 ),
  YAML_PADDING( 16 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_34[] = {
  YAML_UNSIGNED( "source", 8 ),
  YAML_UNSIGNED( "index", 8 ),
  YAML_PADDING( 16 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_35[] = {
  YAML_ARRAY("sources", 8, 4, struct_signed_8, NULL),
  YAML_END
};
static const struct YamlNode struct_anonymous_36[] = {
  YAML_ARRAY("sources", 8, 4, struct_signed_8, NULL),
  YAML_END
};
static const struct YamlNode struct_anonymous_37[] = {
  YAML_UNSIGNED( "source", 8 ),
  YAML_PADDING( 24 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_38[] = {
  YAML_UNSIGNED( "source", 8 ),
  YAML_PADDING( 24 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_39[] = {
  YAML_UNSIGNED( "gps", 8 ),
  YAML_UNSIGNED( "alt", 8 ),
  YAML_PADDING( 16 ),
  YAML_END
};
static const struct YamlNode struct_anonymous_40[] = {
  YAML_UNSIGNED( "gps", 8 ),
  YAML_UNSIGNED( "alt", 8 ),
  YAML_PADDING( 16 ),
  YAML_END
};
static const struct YamlNode union_anonymous_30_elmts[] = {
  YAML_STRUCT("", 32, struct_anonymous_31, NULL),
  YAML_STRUCT("custom", 32, struct_anonymous_32, NULL),
  YAML_STRUCT("", 32, struct_anonymous_33, NULL),
  YAML_STRUCT("cell", 32, struct_anonymous_34, NULL),
  YAML_STRUCT("", 32, struct_anonymous_35, NULL),
  YAML_STRUCT("calc", 32, struct_anonymous_36, NULL),
  YAML_STRUCT("", 32, struct_anonymous_37, NULL),
  YAML_STRUCT("consumption", 32, struct_anonymous_38, NULL),
  YAML_STRUCT("", 32, struct_anonymous_39, NULL),
  YAML_STRUCT("dist", 32, struct_anonymous_40, NULL),
  YAML_UNSIGNED( "param", 32 ),
  YAML_END
};
static const struct YamlNode struct_TelemetrySensor[] = {
  YAML_IDX,
  YAML_UNION("id1", 16, union_anonymous_26_elmts, select_id1),
  YAML_UNION("id2", 8, union_anonymous_27_elmts, select_id2),
  YAML_STRING("label", 4),
  ...
  YAML_PADDING( 1 ),
  YAML_UNION("cfg", 32, union_anonymous_30_elmts, select_sensor_cfg),
  YAML_END
};
