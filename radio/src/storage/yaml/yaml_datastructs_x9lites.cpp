...
static const struct YamlNode struct_RadioData[] = {
  ...
  YAML_ARRAY("switchNames", 24, 7, struct_string_24, NULL),
  YAML_ARRAY("anaNames", 24, 5, struct_string_24, NULL),
  YAML_PADDING( 8 ),
...
static const struct YamlNode struct_FrSkyLineData[] = {
  YAML_IDX,
  YAML_ARRAY("sources", 16, 2, struct_unsigned_16, NULL),
  YAML_END
};
...
static const struct YamlNode struct_ModelData[] = {
  ...
  YAML_UNSIGNED( "switchWarningState", 16 ),
