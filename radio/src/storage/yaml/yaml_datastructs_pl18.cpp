...
const struct YamlIdStr enum_MixSources[] = {
  ...
  {  MIXSRC_CYC2, "CYC2"  },
  {  MIXSRC_CYC3, "CYC3"  },
  {  MIXSRC_TrimTR1, "TrimT1"  },
  {  MIXSRC_TrimTR2, "TrimT2"  },
  {  MIXSRC_TrimTR3, "TrimT3"  },
  {  MIXSRC_TrimTR4, "TrimT4"  },
  {  MIXSRC_TrimTR5, "TrimT5"  },
  {  MIXSRC_TrimTR6, "TrimT6"  },
  {  MIXSRC_TrimTR7, "TrimT7"  },
  {  MIXSRC_TrimTR8, "TrimT8"  },
  {  MIXSRC_SA, "SA"  },
  {  MIXSRC_SB, "SB"  },
  {  MIXSRC_SC, "SC"  },
  {  MIXSRC_SD, "SD"  },
