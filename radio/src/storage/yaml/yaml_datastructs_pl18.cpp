...
const struct YamlIdStr enum_MixSources[] = {
  ...
  {  MIXSRC_CYC2, "CYC2"  },
  {  MIXSRC_CYC3, "CYC3"  },
  {  MIXSRC_TrimTR1, "TrimTR1"  },
  {  MIXSRC_TrimTR2, "TrimTR2"  },
  {  MIXSRC_TrimTR3, "TrimTR3"  },
  {  MIXSRC_TrimTR4, "TrimTR4"  },
  {  MIXSRC_TrimTR5, "TrimTR5"  },
  {  MIXSRC_TrimTR6, "TrimTR6"  },
  {  MIXSRC_TrimTR7, "TrimTR7"  },
  {  MIXSRC_TrimTR8, "TrimTR8"  },
  {  MIXSRC_SA, "SA"  },
  {  MIXSRC_SB, "SB"  },
  {  MIXSRC_SC, "SC"  },
  {  MIXSRC_SD, "SD"  },
