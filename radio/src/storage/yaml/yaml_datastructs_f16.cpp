...
static const struct YamlNode struct_ModelData[] = {
  ...
  YAML_EXTERN_ARRAY("curves", 32, 64, struct_CurveHeader, yaml_get_curves_ptr),
  YAML_EXTERN_ARRAY("points", 8, 1024, struct_signed_8, yaml_get_points_ptr),
  YAML_EXTERN_ARRAY("logicalSw", 72, 64, struct_LogicalSwitchData, yaml_get_logical_sw_ptr),
  YAML_EXTERN_ARRAY("customFn", 88, 64, struct_CustomFunctionData, yaml_get_custom_fn_ptr),
