...
#elif defined(RADIO_T16) && !defined(INTERNAL_MODULE_MPM)
#if  defined(BLUETOOTH)
  #define TRAINER_MODE_MAX()             TRAINER_MODE_SLAVE_BLUETOOTH
#else
  #define TRAINER_MODE_MAX()             TRAINER_MODE_SLAVE
#endif
#elif defined(INTERNAL_MODULE_MPM) || defined(ALLOW_TRAINER_MPM)
  #define TRAINER_MODE_MAX()             TRAINER_MODE_MPM
