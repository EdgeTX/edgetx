...
void copyToTerminated(char (&dest)[DL], const char (&src)[SL], const offset_t<O> = offset_t<0>{}) {
//    static constexpr size_t len = std::min(DL - O - 1, SL); // unfortinately std::min() isn't constexpr in C++11
