...
extern "C" void SDRAM_GPIOConfig(void)
{
  ...
  */
  ...
  /* GPIOC configuration */
  gpio_init_af(GPIO_PIN(GPIOC, 0), GPIO_AF_FMC, GPIO_PIN_SPEED_VERY_HIGH);  // FMC_SDNWE (RAM_WE)
  ...
  // NB: PH5 is USB_VBUS on this board, NOT FMC_SDNWE (write-enable is on PC0).
  // Only PH6 (FMC_SDNE1 / RAM_CS) and PH7 (FMC_SDCKE1 / RAM_CKE) are FMC here.
