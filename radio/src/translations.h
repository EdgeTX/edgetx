...
#define SDEF(x) extern const char STR_##x[];

// Main menu
SDEF(QM_MANAGE_MODELS);
SDEF(QM_MODEL_SETUP);
SDEF(QM_RADIO_SETUP);
SDEF(QM_UI_SETUP);
SDEF(QM_TOOLS);
SDEF(QM_GEN_SETTINGS);
SDEF(QM_FLIGHT_MODES);
SDEF(QM_INPUTS);
SDEF(QM_MIXES);
SDEF(QM_OUTPUTS);
SDEF(QM_CURVES);
...
extern const char STR_MAIN_MENU_APPS[];
...
extern const char STR_MAIN_MENU_THEMES[];
