...
extern const char STR_MPM_PROTOCOLS[];
extern const char STR_MPM_POWER[];
extern const char STR_MPM_TELEMETRY_MODE[];
extern const char STR_MPM_WBUS_MODE[];
...
extern const char STR_MPM_FIXEDID[];
extern const char STR_MPM_OPTION[];
extern const char STR_MPM_VIDFREQ[];
extern const char STR_MPM_RFTUNE[];
extern const char STR_MPM_RFPOWER[];
extern const char STR_MPM_WBUS[];
extern const char STR_MPM_TELEMETRY[];
extern const char STR_MPM_AUTOBIND[];
extern const char STR_DISABLE_CH_MAP[];
extern const char STR_DISABLE_TELEM[];
extern const char STR_MPM_DSM_AUTODTECT[];
extern const char STR_MPM_LOWPOWER[];
extern const char STR_MPM_LNA_DISABLE[];
...
extern const char STR_MPM_SERVOFREQ[];
extern const char STR_MPM_MAX_THROW[];
extern const char STR_MPM_RFCHAN[];
#if LCD_W < 212
...
extern const char STR_EXT_MPM_SPEC[];
extern const char STR_INT_MPM_SPEC[];
...
extern const char STR_WARN_MPM_LOWPOWER[];
...
extern const char STR_FLASH_INTERNAL_MPM[];
extern const char STR_FLASH_EXTERNAL_MODULE[];
extern const char STR_FLASH_EXTERNAL_MPM[];
