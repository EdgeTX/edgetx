...
#define TR_VBLMODE                     "OFF","Кноп.",TR("Ctrl","Controls"),"Подвін.","ON" /* for untranslated - use english */
#define TR_TRNMODE                     "OFF",TR("+=","Дод."),TR(":=","Замін.")
#define TR_TRNCHN                      "CH1","CH2","CH3","CH4"	/* use english */

#define TR_AUX_SERIAL_MODES            "OFF","Дзерк. телем.","Вх. телем.","SBUS Трен.","LUA","CLI","GPS","Отлад.","SpaceMouse","Зовн. модуль"	/* for untranslated - use english */
#define TR_SWTYPES                     "Немає","Перемик.","2поз. пер.","3поз. пер."
#define TR_POTTYPES                    "Немає","Потенц.",TR("Пот. з крок.","Потенц. з кроком"),"Ковзач",TR("Баг.поз.пер.","Багатопозиц. перем."),"Вісь X","Вісь Y","Перемик."
#define TR_VPERSISTENT                 "OFF","Політ","Рурн. скид."	/* for untranslated - use english */
#define TR_COUNTRY_CODES               TR("US","America"),TR("JP","Japan"),TR("EU","Europe")	/* use english */
#define TR_USBMODES                    "Вибір",TR("Joyst","Joystick"),TR("SDCard","Storage"),"Серійн."	/* for untranslated - use english */
...
#define TR_VBEEPCOUNTDOWN              "Тихо","Сигн.","Голос","Вібро",TR2_2("С & В","Синг. & Вібро"),TR2_2("Г & В","Голос & Вібро")
...
#if LCD_W >= 212
  #define TR_SF_SAFETY                 "Відмінити"
#else
  #define TR_SF_SAFETY                 "Відмін."
#endif
...
#define TR_VTRAINER_MASTER_BATTERY     "Майстер/Серійн."
...
#define TR_VFAILSAFE                   "Не встан.","Тримай","Корист.","Нема імпульсу","Приймач"
#define TR_VSENSORTYPES                "Корист.","Обчислено"
#define TR_VFORMULAS                   "Дод.","Середн.","Min","Max","Множ.","Сум.","Комірка","Витрата","Дсиатнц."
#define TR_VPREC                       "0.--","0.0 ","0.00"
#define TR_VCELLINDEX                  "Нижн.","1","2","3","4","5","6","7","8","Вищ.","Різниця"
#define TR_TEXT_SIZE                   "Стд","Наддрібн.","Друбн.","Сер.","Подв."
...
#define TR_USE_GLOBAL_FUNCS            TR("Glob.функц.", "Використов. global функції")
#define TR_PROTOCOL                    TR("Проток.", "Протокол")
  #define TR_PPMFRAME                  INDENT "PPM прейм"
  #define TR_REFRESHRATE               TR(INDENT "Оновл.", INDENT "Частота оновлення")
...
#define TR_COLLECTIVE                  TR("Колекстивний", "Кол. джурело тону")
...
#define TR_NO_INFORMATION              TR("Нема інфо", "Нема інформації")
...
#define TR_BEEP_PITCH                  "Ступінь сигналу"	/*need to be crarifyed by context*/
...
#define TR_THROTTLE_START              "Газв на старт"
#define TR_THROTTLEREVERSE             TR("Газ-реверс", INDENT "Реверс")
#define TR_MINUTEBEEP                  TR("Хв.", "Хв.")
...
#define TR_BLONBRIGHTNESS              INDENT "ON скравість"
#define TR_BLOFFBRIGHTNESS             INDENT "OFF яскравість"
...
#define TR_CUSTOM_THROTTLE_WARNING     TR(INDENT INDENT INDENT INDENT "Корист-пол.", INDENT INDENT INDENT INDENT "Користувацька положення?")
#define TR_CUSTOM_THROTTLE_WARNING_VAL TR("Пол. %", "Положення %")
#define TR_SWITCHWARNING               TR(INDENT "Пер.поз.", INDENT "Позиція перемикача")		/*need to be crarifyed by context*/
#define TR_POTWARNINGSTATE             TR(INDENT "Пот&жвиж.", INDENT "Пот & движки")			/*need to be crarifyed by context*/
#define TR_SLIDERWARNING               TR(INDENT "Жвиж. поз.", INDENT "Позиція движків")		/*need to be crarifyed by context*/
...
#define TR_DEF_CHAN_ORD                TR("пор. кан. замовч.", "Порядок каналу по замовчюванню")
#define TR_STICKS                      "Вісі"
#define TR_POTS                        "Потенціометри"
#define TR_SWITCHES                    "Перемикачі"
#define TR_SWITCHES_DELAY              TR("Затримка відтвор.", "Затримка відтворення (серед. пол. перем.)")
...
#define TR_CALIB_DONE                  "Калібровка завершена"
#if defined(PCBHORUS)
  #define TR_MENUTOSTART               "Тисни [Enter] для старту"
  #define TR_SETMIDPOINT               "Центруй важіль/потенц./движки та тисни [Enter]"
  #define TR_MOVESTICKSPOTS            "Рухай важелі/потенц./движки та тисни [Enter]"
#elif defined(COLORLCD)
  #define TR_MENUTOSTART               TR_ENTER " ДЛЯ СТАРТУ"
  #define TR_SETMIDPOINT               "ЦЕНТРУВАТИ ВАЖЕЛІ/ДВИЖКИ"
  #define TR_MOVESTICKSPOTS            "РУХАТИ ВІСІ/ПОТЕНЦ."
#else
  #define TR_MENUTOSTART               CENTER "\010" TR_ENTER " ДЛЯ СТАРТУ"
  #define TR_SETMIDPOINT               TR(CENTER "\004ВСТАН ЦНТР ВАЖУЛІВ", CENTER "\004ЦЕНТР ВАЖЕЛІ/ДВИЖКИ")
...
#define TR_DURATION_MS             TR("[D]","Тривалість(ms): ")
#define TR_INTERVAL_MS             TR("[I]","Інтервал(ms): ")
...
#define TR_GPS_FIX_YES                 "Фікс: Так"
#define TR_GPS_FIX_NO                  "Фікс: Ні"
...
#define TR_PRESS_ANY_KEY_TO_SKIP       "Будь-яка кнопка - пропуск"
#define TR_THROTTLE_NOT_IDLE           "Газ не вільний"
#define TR_ALARMSDISABLED              "Авар.Сингали симкнені"
#define TR_PRESSANYKEY                 TR("\010Тисни будь-яку кнопку", "Тисни будь-яку кнопку")
#define TR_BADEEPROMDATA               "невірні дані EEprom"
#define TR_BAD_RADIO_DATA              "Відсутні або пагані радіодані"
#define TR_RADIO_DATA_RECOVERED        TR3("Користую запасні радіодані","Користую запасні установки радіо","Установки радіо відновлені з backup")
#define TR_RADIO_DATA_UNRECOVERABLE    TR3("Невірні установки радіо","Недійсні установки радіо", "Не можу проситати правильні установки радіо")
...
#define TR_RADIO_SETUP                 "УСТАНОВКИ РАДІО"
...
#define TR_MENU_RADIO_ANALOGS_RAWLOWFPS "СИРІ АНАЛОГИ (5 Hz)"
...
#define TR_MENULOGICALSWITCH           "ЛОГІЧНІ ПЕРЕМИКАЧ"
#define TR_MENULOGICALSWITCHES         "ЛОГІЧНІ ПЕРЕМИКАЧІ"
#define TR_MENUCUSTOMFUNC              "СПЕЦІАЛЬНІ ФУНКЦІЇ"
#define TR_MENUCUSTOMSCRIPTS           "КОРИСТУВАЦЬКИ СКРИПТИ"
#define TR_MENUTELEMETRY               "ТЕЛЕНМЕТРІЯ"
...
#define TR_MONITOR_SWITCHES            "МОНИТОР ЛОГІЧНИХ ПЕРЕМИКАЧІВ"
...
#define TR_MULTI_RFPOWER               "RF power"		/* use english */
#define TR_MULTI_WBUS                  "Вихід"
#define TR_MULTI_TELEMETRY             "Телеметрія"
#define TR_MULTI_VIDFREQ               TR("Від.Част.", "Відео частота")
#define TR_RF_POWER                    "RF Power"	/* use english */
#define TR_MULTI_FIXEDID               TR("FixedID", "Fixed ID")		/* use english */
#define TR_MULTI_OPTION                TR("Опція", "Значення опції")
#define TR_MULTI_AUTOBIND              TR(INDENT "Прив'язка на кан.", INDENT "Прив'язка на канал")
#define TR_DISABLE_CH_MAP              TR("Нема.кан.карти", "Вимкнути карту каналів")
#define TR_DISABLE_TELEM               TR("Нема телеметрії", "Вимкнути телеметрію")
#define TR_MULTI_DSM_AUTODTECT         TR(INDENT "Автовизначення", INDENT "Формат автовизначення")
#define TR_MULTI_LOWPOWER              TR(INDENT "Низька потужн.", INDENT "Ркжим нізької потужності")
...
#define TR_DISABLE_INTERNAL            TR("Дект. внутр.", "Деактивувати внутр. RF")
#define TR_MODULE_NO_SERIAL_MODE       TR("Не сер.реж.", "Не в серіальному режимі")
#define TR_MODULE_NO_INPUT             TR("Немає входу", "Немає серіального входу")
#define TR_MODULE_NO_TELEMETRY         TR3("Нема телеметрії", "Нема телеметрії", "Телеметрія не визначена")
#define TR_MODULE_WAITFORBIND          "Прив'язка до завантаж. протоколу"
#define TR_MODULE_BINDING              TR("Прив'язка...","Прив'язую")
#define TR_MODULE_UPGRADE_ALERT        TR3("Потрібен апгр.", "Потрібен апгрейд модулю", "Потрібен\nАпгрейд модулю")
#define TR_MODULE_UPGRADE              TR("Апг.реком.", "Рекомендовано апгрейд модулю")
#define TR_REBIND                      "Потрібна переприв'язка"
#define TR_REG_OK                      "Регістрація ok"
...
#define TR_MODULE_STATUS               TR(INDENT "Статус", INDENT "Статус модулю")
...
#define TR_AFHDS3_ONE_TO_ONE_TELEMETRY TR("Unicast/Тел.", "Unicast/Телеметрія")
#define TR_AFHDS3_ONE_TO_MANY          "Multicast"
#define TR_AFHDS3_ACTUAL_POWER         TR("Факт.пот.", "Фактична потужність")
...
#define TR_REPEAT_AT_ZERO              "Порвтори нуль"
#define TR_BATT_CALIB                  TR("Batt. калібр.", "Battery калібровка")
#define TR_CURRENT_CALIB               "Калібровка струму"
#define TR_VOLTAGE                     TR(INDENT "Напруга", INDENT "Джерело напруги")
...
#define TR_MOVE_UP                     "Рух вгору"
#define TR_MOVE_DOWN                   "Рух вниз"
...
#define TR_NOT_CONNECTED               TR("!З'єдн.", "Не з'єднано");
...
#define TR_SHOW_MIXER_MONITORS         "Показати монтори мікшеру"
#define TR_MENU_MODULES_RX_VERSION     "МОДУЛІ / RX ВЕРСІЯ"
#define TR_MENU_FIRM_OPTIONS           "FIRMWARE ОПЦІЇ"
#define TR_IMU                        "IMU"
#define TR_STICKS_POTS_SLIDERS         "Важелі/Потенц./Движки"
#define TR_PWM_STICKS_POTS_SLIDERS     "PWM Важелі/Потенц./Движки"
#define TR_RF_PROTOCOL                 "RF протокол"
#define TR_MODULE_OPTIONS              "Опції модулю"
#define TR_POWER                       "Потужність"
#define TR_NO_TX_OPTIONS               "Нема опцій TX"
...
#define TR_SDCARD_CONVERSION_REQUIRE   "Потрібгне перетворення SD карти"
...
#define TR_NO_FAILSAFE                 "Аварійний режим налаштовано"
...
#define TR_TTL_WARNING                 "Попередження: використайте логічні рівні 3.3V"
...
#define TR_NO_SOUNDS_ON_SD             "Нема звуків на SD"
#define TR_NO_MODELS_ON_SD             "Нема моделей на SD"
#define TR_NO_BITMAPS_ON_SD            "Нема бітмапів на SD"
#define TR_NO_SCRIPTS_ON_SD            "Нема скриптів на SD"
...
#define TR_DELETE_THEME                "Видалити час?"
#define TR_SAVE_THEME                  "Зберігти тему?"
#define TR_EDIT_COLOR                  "Редагувати колір"
#define TR_NO_THEME_IMAGE              "Нема зображення теми"
...
#define TR_CHANNELS_MONITOR            "МОНИТОР КАНАЛІВ"
#define TR_MIXERS_MONITOR              "МОНИТОР МІКШЕРУ"
...
#define TR_FLASH_EXTERNAL_DEVICE       TR("Прошити сер.порт", "Прошити сер.порт пристрій")
...
#define TR_FAILSAFE                    TR(INDENT "Відмова", INDENT "Режим відмови")
...
#define TR_POWERMETER_POWER            "Потужнісь"
...
#define TR_USB_JOYSTICK                "USB Ждойстик (HID)"
#define TR_USB_MASS_STORAGE            "USB Сховище (SD)"
#define TR_USB_SERIAL                  "USB Серійний (VCP)"
...
#define TR_BYTES                       "бійти"
#define TR_MODULE_BIND                 BUTTON(TR("Скр", "Скріпити"))
...
#define TR_TOUCH_NOTFOUND              "Touch hardware не знайдено"
#define TR_TOUCH_EXIT                  "Тицніть екран щоб вийти"
#define TR_SET                         BUTTON("Встановл.")
#define TR_TRAINER                     "Треінер"
#define TR_CHANS                       "Канали"
#define TR_ANTENNAPROBLEM              CENTER "Помилка TX антени!"
...
#define TR_CHANNELRANGE                TR(INDENT "Діапазон кан.", INDENT "Діапазон каналу")
...
#define TR_LOWALARM                    INDENT "Некритична аварія"
#define TR_CRITICALALARM               INDENT "Критична аварія"
#define TR_DISABLE_ALARM               TR(INDENT "Вимкнути аварії", INDENT "Вимкнути аварії телеметрії)")
...
#define TR_COPY_MIN_MAX_TO_OUTPUTS     TR("Коп min/max то всі",  "Копіювати min/max/center до всіх виходів")
...
#define TR_AUX_SERIAL_MODE             "Серійний порт"
#define TR_AUX2_SERIAL_MODE            "Серійний порт 2"
#define TR_AUX_SERIAL_PORT_POWER       "Рорт живлення"
...
#define TR_CONFIRMRESET                TR("Стерти все", "Стерти установки всіх моделей?")
...
#define TR_TOUCH_PANEL                 "Сесорна панель:"
#define TR_FILE_SIZE                   "Розмій файлу"
...
#define TR_LSW_DESCRIPTIONS            { "Порівняння типу іункції", "Перша змінна", "Друга змінна або постійна", "Друга змінна або постійна", "Додаткова умова для активації лінії", "Мінімальна тривалість ON для логічного перемикача", "Мінімальна тривалість TRUE для перемикача, що стає ON" }
  ...
  #define TR_SLIDERS_TRIMS             "Движки+трими"
  #define TR_SLIDERS                   "Движки"
...
#define TR_BL_DIR_MISSING             " Напрямок втрачено"
...
#define TR_IGNORE_INSTANCE             TR(INDENT "Немає інстанса.", INDENT "Ігнорувати інстанси")
...
#define TR_SETUP_WIDGETS               "Налштування віджетів"
...
#define TR_BAR1_COLOR                  "Колір основної панелі"
#define TR_TEXT_COLOR                  "Колір тексту"
#define TR_TEXT_VIEWER                 "Переглядач тексту"
...
#define TR_AUDIO_MUTE                  TR("Аудіо стоп","Тихо якщо нема звуку")
#define TR_JITTER_FILTER               "фільтер ADC"
#define TR_DEAD_ZONE                   "Мертва зона"
#define TR_RTC_CHECK                   TR("Перевір RTC", "Перевір RTC напругу")
#define TR_AUTH_FAILURE                "Помилка авторизації"
#define TR_RACING_MODE                 "Режим гонки"

#define TR_USE_THEME_COLOR              "Користуй колір теми"

#define TR_ADD_ALL_TRIMS_TO_SUBTRIMS    "Довдати все трими до субтримів"
#if LCD_W > LCD_H
...
#define TR_THEME_ACTIVE                "Акстивний"
...
#define TR_MAIN_MENU_SCREEN_SETTINGS    "Екоани\nУстановки"
...
#define TR_USBJOYSTICK_SETTINGS        "Установки каналу"
#define TR_USBJOYSTICK_IF_MODE         TR("Режим ІФ","Режим інтерфейсу")
#define TR_VUSBJOYSTICK_IF_MODE        "Джойстик","Gamepad","MultiAxis"
...
#define TR_VUSBJOYSTICK_CIRC_COUTOUT   "Нема","X-Y, Z-rX","X-Y, rX-rY"
...
#define TR_SERIAL_BUS             "Серійна шина"
#define TR_SYNC                   "Сихро"
