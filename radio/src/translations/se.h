...
#define TR_AUX_SERIAL_MODES             "AV","Speglad telemetri","Telemetri in","SBUS Lärare","IBUS Lärare","CRSF Lärare","SUMD Lärare","LUA","CLI","GPS","Debug","SpaceMouse","Extern modul"
