...
#define TR_VFSWFUNC            TR_SF_SAFETY,"Entrenador","Instant Trim","Reset","Ajuste",TR_ADJUST_GVAR,"Volumen","Set Failsafe","Check Rango","Enl.módulo",TR_SOUND,TR_PLAY_TRACK,TR_PLAY_VALUE,TR_SF_RESERVE,TR_SF_PLAY_SCRIPT,TR_SF_RESERVE,TR_SF_BG_MUSIC,TR_VVARIO,TR_HAPTIC,TR_SDCLOGS,"Luz Fondo",TR_SF_SCREENSHOT,TR_SF_RACING_MODE,TR_SF_DISABLE_TOUCH TR_SF_TEST
