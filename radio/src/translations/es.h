...
#define TR_AUX_SERIAL_MODES    "UIT","Telem Mirror","Telemetría","Entrenador SBUS","Entrenador IBUS","Entrenador CRSF","Entrenador SUMD","LUA","CLI","GPS","Debug","SpaceMouse","Módulo externo"
