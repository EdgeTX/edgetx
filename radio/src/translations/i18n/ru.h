...
#define TR_EASYMODE                    "Простой режим"
#define TR_EASYMODE_MODEL_TYPE         "Тип модели"
#define TR_EASYMODE_WING_TYPE          "Тип крыла"
#define TR_EASYMODE_TAIL_TYPE          "Тип хвоста"
#define TR_EASYMODE_MOTOR_TYPE         "Тип мотора"
#define TR_EASYMODE_CHANNEL_MAP        "Карта каналов"
#define TR_EASYMODE_OPTIONS            "Опции"
#define TR_EASYMODE_EXPO               "Expo"
#define TR_EASYMODE_DUAL_RATE          "D/R низкий"
#define TR_EASYMODE_AIL_DIFF           "Дифф. элеронов"
#define TR_EASYMODE_AIL2RUD            "Элероны на руль"
#define TR_EASYMODE_FLAP2ELE           "Комп. закр./руль выс."
#define TR_EASYMODE_CH_ORDER           "Порядок каналов"
#define TR_EASYMODE_CONVERT            "В режим Эксперт"
#define TR_EASYMODE_CONVERT_CONFIRM    "Конвертировать?\nМиксы станут ручными."
#define TR_EASYMODE_AIRPLANE           "Самолёт"
#define TR_EASYMODE_HELICOPTER         "Вертолёт"
#define TR_EASYMODE_GLIDER             "Планер"
#define TR_EASYMODE_MULTIROTOR         "Мультиротор"
#define TR_EASYMODE_CAR                "Машина"
#define TR_EASYMODE_BOAT               "Лодка"
#define TR_EASYMODE_WING_SINGLE_AIL    "Один элерон"
#define TR_EASYMODE_WING_DUAL_AIL      "Два элерона"
#define TR_EASYMODE_WING_FLAPERON      "Флаперон"
#define TR_EASYMODE_WING_1A1F          "1Эл+1Закр"
#define TR_EASYMODE_WING_2A1F          "2Эл+1Закр"
#define TR_EASYMODE_WING_2A2F          "2Эл+2Закр"
#define TR_EASYMODE_WING_2A4F          "2Эл+4Закр"
#define TR_EASYMODE_WING_ELEVON        "Элевон"
#define TR_EASYMODE_WING_DELTA         "Дельта"
#define TR_EASYMODE_TAIL_NORMAL        "Нормальный"
#define TR_EASYMODE_TAIL_VTAIL         "V-Хвост"
#define TR_EASYMODE_TAIL_TAILLESS      "Бесхвостка"
#define TR_EASYMODE_TAIL_DUAL_ELE      "Двойн. руль высоты"
#define TR_EASYMODE_TAIL_AILEVATOR     "Элеватор"
#define TR_EASYMODE_MOTOR_NONE         "Нет"
#define TR_EASYMODE_MOTOR_ELECTRIC     "Электро"
#define TR_EASYMODE_MOTOR_NITRO        "ДВС"
#define TR_EASYMODE_CH_AILERON         "Элерон"
#define TR_EASYMODE_CH_ELEVATOR        "Руль высоты"
#define TR_EASYMODE_CH_THROTTLE        "Газ"
#define TR_EASYMODE_CH_RUDDER          "Руль напр."
#define TR_EASYMODE_CH_STEERING        "Руль"
#define TR_EASYMODE_CH_AIL2            "Ail. 2"
#define TR_EASYMODE_CH_ELE2            "Elev. 2"
#define TR_EASYMODE_CH_FLAP            "Закрылок"
#define TR_EASYMODE_CH_FLAP2           "Flap 2"
#define TR_EASYMODE_CH_BRAKEL          "Тормоз L"
#define TR_EASYMODE_CH_BRAKER          "Тормоз R"
...
#define TR_EASYMODE_CH_GYRO            "Усил. гиро"
