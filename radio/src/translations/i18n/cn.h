...
#define TR_AUX_SERIAL_MODES_1          "调试"
...
#define TR_SETMIDPOINT                 TR_BW_COL(TR_SFC_AIR("校准中点", TR("校准中点", "校准中点")), "校准中点，按[Enter]保存")
#define TR_MOVESTICKSPOTS              TR_BW_COL(TR_SFC_AIR("校准边界", "校准边界"), "校准边界，按[Enter]保存并完成")
...
#define TR_ANTENNA_MODES_4           "外置天线"s
