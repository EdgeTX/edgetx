...
#define TR_CUSTOM_THROTTLE_WARNING     TR(INDENT INDENT INDENT INDENT "Cust-Pos", INDENT INDENT INDENT INDENT "指定油门位置?")
...
#define TR_MENU_RADIO_ANALOGS          TR("ANALOGS", "模拟输入测试")
...
#define TR_ANALOGS_BTN                 BUTTON(TR("Anas", "模拟量"))
