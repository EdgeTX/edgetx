...
#define TR_AUX_SERIAL_MODES            "POIS","S-Port Pelik","Telemetry In","SBUS Trainer","IBUS Trainer","CRSF Trainer","SUMD Trainer","LUA","CLI","GPS","Debug","SpaceMouse","External module"
