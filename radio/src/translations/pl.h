...
#define TR_USER_INTERFACE      "Interfejs uzytkownika"
...
#define TR_MENU_SWITCHES        STR_CHAR_SWITCH "Przełczniki"
...
#define TR_ADD_ALL_TRIMS_TO_SUBTRIMS    "Dodaj trymery do podtrym."
#if LCD_W > LCD_H
