...
#define TR_AUX_SERIAL_MODES            "AUS","Telem Mirror","Telemetry In","FrSky D In","SBUS Eingang","IBUS Eingang","CRSF Eingang","SUMD Eingang","LUA","CLI","GPS","Debug","SpaceMouse", "ExtModule"
