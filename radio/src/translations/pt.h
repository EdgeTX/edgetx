...
// Main menu
#define TR_MAIN_MENU_SELECT_MODEL       "Selecionar Modelo"
...
#define TR_MAIN_MENU_MODEL_SETTINGS     "Config. Modelo"
#define TR_MAIN_MENU_RADIO_SETTINGS     "Config. Rádio"
#define TR_MAIN_MENU_SCREEN_SETTINGS    "Config. Tela"
