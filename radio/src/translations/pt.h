...
#define TR_AUX_SERIAL_MODES            "OFF","Espelhar Telem","Entr Telem","Trainer SBUS","Trainer IBUS","LUA","CLI","GPS","Debug","SpaceMouse","External module"
...
#define TR_VTRAINER_MASTER_IBUS_MODULE "Mestre/IBUS Module"
