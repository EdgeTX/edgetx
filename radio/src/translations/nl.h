...
#define TR_AUX_SERIAL_MODES    "UIT","Telem Mirror","Telemetry In","SBUS Leerling","IBUS Leerling","CRSF Leerling","SUMD Leerling","LUA","CLI","GPS","Debug","SpaceMouse","External module"
