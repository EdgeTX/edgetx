...
#define TELEMETRY_DIR_OUTPUT()          GPIO_SetBits(TELEMETRY_DIR_GPIO, TELEMETRY_DIR_GPIO_PIN);
#define TELEMETRY_DIR_INPUT()           GPIO_ResetBits(TELEMETRY_DIR_GPIO, TELEMETRY_DIR_GPIO_PIN);
