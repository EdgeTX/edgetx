...
const uint8_t TOUCH_GT911_Cfg[] = {
    ...
    0x01,
    GT911_MAX_TP,  // 0x804C Touch number
    0x0C,          // 0x804D Module switch 1 : 180° rotation
    0x00,          // 0x804E Module switch 2
    0x01,          // 0x804F Shake_Count
    0x08,          // 0x8050 Filter
    0x28,          // 0x8051 Larger touch
    ...
    0x50,          // 0x8053 Screen touch level
    0x32,          // 0x8054 Screen touch leave
    0x03,          // 0x8055 Low power control
    ...
    0x00,          // 0x805B Space (top, bottom)
    0x00,          // 0x805C Space (left, right)
    0x00,          // 0x805D Mini filter
    0x00,          // 0x805E Strech R0
    0x00,          // 0x805F Strech R1
    0x00,          // 0x8060 Strech R2
    0x00,          // 0x8061 Strech RM
    0x8B,          // 0x8062 Drv groupA num
    0x2B,          // 0x8063 Drv groupB num
    0x0C,          // 0x8064 Sensor num
    0x17,          // 0x8065 FreqA factor
    0x15,          // 0x8066 FreqB factor
    0x31,          // 0x8067 Panel bit freq
    0x0D,
    0x00,  // 0x8069 Reserved
    0x00,
    0x01,  // 0x806B Panel tx gain
    0x9A,  // 0x806C Panel rx gain
    0x04,  // 0x806D Panel dump shift
    0x2C,  // 0x806E Drv frame control
    ...
    0x00,  // 0x8073 X/Y slope adjust
    0x03,  // 0x8074 Gesture control
    0x64,  // 0x8075 Gesture switch 1
    0x32,  // 0x8076 Gesture switch 2
    0x00,  // 0x8077 Gesture refresh rate
    0x00,  // 0x8078 Gesture touch level
    0x00,  // 0x8079 New green wake up level
    0x00,  // 0x807A Freq hopping start
    0x00,  // 0x807B Freq hopping end
    0x00,  // 0x807C Noise detect time
    0xC0,  // 0x807D Hopping flag
    0x00,  // 0x807E Hopping flag
    0x00,  // 0x807F Noise threshold
    0x00,  // 0x8080 Nois min threshold old
    0x00,  // 0x8081 Reserved
    0x00,  // 0x8082 Hopping sensor group
    0x9B,  // 0x8083 Hopping Seg1 normalize
    0x11,  // 0x8084 Hopping Seg1 factor
    0x00,  // 0x8085 Main clock adjust
    0x59,  // 0x8086 Hopping Seg2 normalize
    0x1F,  // 0x8087 Hopping Seg2 factor
    0x00,  // 0x8088 Reserved
    0x35,  // 0x8089 Hopping Seg3 normalize
    0x37,  // 0x808A Hopping Seg3 factor
    0x00,  // 0x808B Reserved
    0x22,  // 0x808C Hopping Seg4 normalize
    0x61,  // 0x808D Hopping Seg4 factor
    0x00,  // 0x808E Reserved
    0x1B,  // 0x808F Hopping Seg5 normalize
    0xAB,  // 0x8090 Hopping Seg5 factor
    0x00,  // 0x8091 Reserved
    0x1B,  // 0x8092 Hopping Seg6 normalize
    0x00,  // 0x8093 Key1
    0x00,  // 0x8094 Key2
    0x00,  // 0x8095 Key3
    0x00,  // 0x8096 Key4
    ...
    0x00,  // 0x80B5 Reserved
    0x00,  // 0x80B6 Reserved
    0x18,  // 0x80B7 Sensor CH0
    0x16,  // 0x80B8 Sensor CH1
    0x14,  // 0x80B9 Sensor CH2
    0x12,  // 0x80BA Sensor CH3
    0x10,  // 0x80BB Sensor CH4
    0x0E,  // 0x80BC Sensor CH5
    0x0C,  // 0x80BD Sensor CH6
    0x0A,  // 0x80BE Sensor CH7
    0x08,  // 0x80BF Sensor CH8
    0x06,  // 0x80C0 Sensor CH9
    0x04,  // 0x80C1 Sensor CH10
    0x02,  // 0x80C2 Sensor CH11
    0xFF,  // 0x80C3 Sensor CH12
    0xFF,  // 0x80C4 Sensor CH13
    0xFF,  // 0x80C5 Reserved
    0xFF,  // 0x80C6 Reserved
    ...
    0xFF,  // 0x80D3 Reserved
    0xFF,  // 0x80D4 Reserved
    0x26,  // 0x80D5 Driver CH0
    0x24,  // 0x80D6 Driver CH1
    0x22,  // 0x80D7 Driver CH2
    0x21,  // 0x80D8 Driver CH3
    0x20,  // 0x80D9 Driver CH4
    0x1F,  // 0x80DA Driver CH5
    0x1E,  // 0x80DB Driver CH6
    0x1D,  // 0x80DC Driver CH7
    0x1C,  // 0x80DD Driver CH8
    0x18,  // 0x80DE Driver CH9
    0x16,  // 0x80DF Driver CH10
    0x13,  // 0x80E0 Driver CH11
    0x12,  // 0x80E1 Driver CH12
    0x10,  // 0x80E2 Driver CH13
    0x0F,  // 0x80E3 Driver CH14
    0x0C,  // 0x80E4 Driver CH15
    0x0A,  // 0x80E5 Driver CH16
    0x08,  // 0x80E6 Driver CH17
    0x06,  // 0x80E7 Driver CH18
    0x04,  // 0x80E8 Driver CH19
    0x02,  // 0x80E9 Driver CH20
    0x00,  // 0x80EA Driver CH21
    0xFF,  // 0x80EB Driver CH22
    0xFF,  // 0x80EC Driver CH23
    0xFF,  // 0x80ED Driver CH24
    0xFF,  // 0x80EE Driver CH25
