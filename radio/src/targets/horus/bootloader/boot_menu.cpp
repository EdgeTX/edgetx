...
LAYOUT_VAL_SCALED(LINE_X1, 28)
LAYOUT_VAL_SCALED(LINE_W, 422)
static constexpr coord_t LINE_H = 2;

LAYOUT_VAL_SCALED(TITLE_X1, 88)
LAYOUT_VAL_SCALED(TITLE_Y1, 28)
LAYOUT_VAL_SCALED(TITLE_Y2, 56)

LAYOUT_VAL_SCALED(FOOTER_Y1, 30)
LAYOUT_VAL_SCALED(FOOTER_Y2, 38)

LAYOUT_VAL_SCALED(SYM_X, 102)
LAYOUT_VAL_SCALED(SYM_X2, 100)
LAYOUT_VAL_SCALED(LBL_X, 124)
...
LAYOUT_VAL_SCALED(OPTBOX_X, 92)

LAYOUT_VAL_SCALED(USB_ICN_X, 60)
LAYOUT_VAL_SCALED(USB_PLG_X, 136)
LAYOUT_VAL_SCALED(USB_ICN_Y, 106)
LAYOUT_VAL_SCALED(USB_TXT_X, 195)
LAYOUT_VAL_SCALED(USB_TXT_Y1, 97)
LAYOUT_VAL_SCALED(USB_TXT_Y2, 72)

LAYOUT_VAL_SCALED(FILENAM_X1, 94)
LAYOUT_VAL_SCALED(FILENAM_X2, 124)
LAYOUT_VAL_SCALED(FILENAM_Y1, 75)
LAYOUT_VAL_SCALED(FILENAM_H, 25)
LAYOUT_VAL_SCALED(FILESEL_X, 119)
LAYOUT_VAL_SCALED(FILESEL_W, 278)

LAYOUT_VAL_SCALED(NLSYM_X, 305)
LAYOUT_VAL_SCALED(RTNTXT_X, 335)

LAYOUT_VAL_SCALED(DIRMSG_X, 90)
LAYOUT_VAL_SCALED(DIRMSG_Y, 168)

LAYOUT_VAL_SCALED(PROGRESS_X, 70)
LAYOUT_VAL_SCALED(PROGRESS_W, 340)
LAYOUT_VAL_SCALED(PROGRESS_H, 31)

LAYOUT_VAL_SCALED(VERCHK_X, 168)
LAYOUT_VAL_SCALED(VERCHK_Y, 138)
LAYOUT_VAL_SCALED(VERCHK_ICN_X, 78)
