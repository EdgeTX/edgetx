...
void csd203Init(void)
{
	...
	{
		//delay_ms(10);
		//CSD203_ReadCONFIGURATION(&CSD203_CFG);
		//delay_ms(1);
		CSD203_ReadVbus(&CSD203_CFG);
		//delay_ms(1);
		CSD203_ReadRshunt(&CSD203_CFG);
		//delay_ms(1);
		CSD203_ReadCurrent(&CSD203_CFG);
		CSD203_ReadPower(&CSD203_CFG);
