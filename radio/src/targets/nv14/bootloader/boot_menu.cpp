...
#define BL_RED        COLOR2FLAGS(COLOR_THEME_WARNING)
...
//  lcdColorTable[COLOR_THEME_PRIMARY3_INDEX]      = COLOR_THEME_WARNING;
//  lcdColorTable[COLOR_THEME_SECONDARY1_INDEX] = COLOR_THEME_WARNING;
