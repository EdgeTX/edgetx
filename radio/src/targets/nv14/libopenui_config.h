...
constexpr uint32_t MENU_HEADER_BUTTON_WIDTH =      36;
constexpr uint32_t MENU_HEADER_BUTTONS_LEFT =      47;

constexpr uint32_t MENU_HEADER_HEIGHT =            50;
constexpr uint32_t MENU_TITLE_TOP =                53;
constexpr uint32_t MENU_TITLE_HEIGHT =             26;
...
constexpr coord_t  PAGE_PADDING =                  8;
constexpr uint32_t PAGE_LINE_HEIGHT =              28;
constexpr uint32_t PAGE_LINE_SPACING =             4;
constexpr uint32_t PAGE_INDENT_WIDTH =             10;
constexpr uint32_t PAGE_LABEL_WIDTH =              160;
...
constexpr uint32_t FIELD_PADDING_LEFT =            6;
constexpr uint32_t FIELD_PADDING_TOP =             5;
