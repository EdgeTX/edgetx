...
#define IS_UCHARGER_CHARGE_END_ACTIVE()   gpio_read(UCHARGER_CHARGE_END_GPIO)
#define ENABLE_UCHARGER()                 gpio_set(UCHARGER_EN_GPIO)
#define DISABLE_UCHARGER()                gpio_clear(UCHARGER_EN_GPIO)

#define IS_WCHARGER_ACTIVE()              gpio_read(WCHARGER_GPIO)
#define IS_WCHARGER_CHARGE_END_ACTIVE()   gpio_read(WCHARGER_CHARGE_END_GPIO)
