...
// Serial Port
#if (defined(PCBX7) && !defined(RADIO_ZORRO) && !defined(RADIO_TX12MK2) && !defined(RADIO_X7ACCESS) && !defined(RADIO_X7)) || defined(PCBXLITE) || defined(PCBX9LITE) || defined(RADIO_T8) || defined(RADIO_COMMANDO8) || defined(RADIO_X9LITE)
...
// Serial Port Aux2, X9E is the only one that can have two AuxSerials
#if defined(PCBX9E)
  #define AUX2_SERIAL_RCC_AHB1Periph         (RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOE | RCC_AHB1Periph_GPIOG)
  ...
  #define AUX2_SERIAL_GPIO_AF_LL             LL_GPIO_AF_7
...
// Bluetooth enabled boards, Enable Pins
#if defined(PCBX9E)
