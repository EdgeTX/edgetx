...
//lcd->drawNumber(195, 273, g_tmr10ms, BL_FOREGROUND, 8, "", "");
      ...
      lcd->drawText(102, 75, LV_SYMBOL_USB, BL_FOREGROUND);
      coord_t pos = lcd->drawText(124, 75, rfUsbAccess ? TR_DISABLE : TR_ENABLE, BL_FOREGROUND);
      pos += 8;
