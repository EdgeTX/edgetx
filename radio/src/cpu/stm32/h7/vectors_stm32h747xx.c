...
/* stm32h747xx specific interrupt vectors */
...
WEAK_DEFAULT void CM7_SEV_IRQHandler();
WEAK_DEFAULT void CM4_SEV_IRQHandler();
...
const isr_t g_pnfVectors[] ISR_VECTOR = {
  ...
  [CM7_SEV_IRQn + 16                  ] = CM7_SEV_IRQHandler,
  [CM4_SEV_IRQn + 16                  ] = CM4_SEV_IRQHandler,
