...
#define SIGNAL_PATH_RESET     0x11
#define ACCEL_CONFIG0_REG     0x50
#define GYRO_CONFIG0_REG      0x4F
#define TEMP_DATA_X0_REG      0x1D

// Config values
#define SOFT_RESET_CMD        0x01

#define PWR_MGMT0_ENABLE      0x0F  // ACCEL_LNM + GYRO_LNM
#define ACCEL_ODR_1KHZ        0x46  // Accel 1 kHz ±4g
#define GYRO_ODR_1KHZ         0x06  // Gyro 1 kHz  ±2000 dps

#define GYRO_DATA_X0_REG      0x25
#define ACCEL_DATA_X0_REG     0x1F

#define BLK_SEL_W_REG         0x76
#define MADDR_W_REG           0x7A
#define M_W_REG               0x7B
#define ACCEL_WOM_X_THR_REG   0x4A
#define ACCEL_WOM_Y_THR_REG   0x4B
#define ACCEL_WOM_Z_THR_REG   0x4C
