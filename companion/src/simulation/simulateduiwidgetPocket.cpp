...
#include "ui_simulateduiwidgetPocket.h"

// NOTE: RadioUiAction(NUMBER,...): NUMBER relates to enum EnumKeys in the specific board.h

SimulatedUIWidgetPocket::SimulatedUIWidgetPocket(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetPocket)
{
  RadioUiAction * act;
...
SimulatedUIWidgetPocket::~SimulatedUIWidgetPocket()
{
  delete ui;
}
