...
#include "ui_simulateduiwidgetEL18.h"

SimulatedUIWidgetEL18::SimulatedUIWidgetEL18(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetEL18)
{
  RadioUiAction * act;
...
SimulatedUIWidgetEL18::~SimulatedUIWidgetEL18()
{
  delete ui;
}
