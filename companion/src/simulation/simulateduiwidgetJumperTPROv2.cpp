...
#include "ui_simulateduiwidgetJumperTPROv2.h"

// NOTE: RadioUiAction(NUMBER,...): NUMBER relates to enum EnumKeys in the specific board.h

SimulatedUIWidgetJumperTPROv2::SimulatedUIWidgetJumperTPROv2(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetJumperTPROv2)
{
  RadioUiAction * act;
...
SimulatedUIWidgetJumperTPROv2::~SimulatedUIWidgetJumperTPROv2()
{
  delete ui;
}
