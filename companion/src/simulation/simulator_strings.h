...
#define SIMU_STR_HLP_KEY_GT            QCoreApplication::translate("SimulatedUIWidget", "<font size=+3>&gt</font>")
#define SIMU_STR_HLP_KEY_LT            QCoreApplication::translate("SimulatedUIWidget", "<font size=+3>&lt</font>")
