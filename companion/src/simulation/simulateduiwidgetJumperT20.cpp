  ...
  ui(new Ui::SimulatedUIWidgetJumperT20)
{
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(10, 40, 51, 28), "JumperT20/left.png", act));

  act = new RadioUiAction(3, QList<int>() << Qt::Key_PageDown << Qt::Key_Down, SIMU_STR_HLP_KEYS_GO_DN, SIMU_STR_HLP_ACT_PAGE);
  addRadioWidget(ui->leftbuttons->addArea(QRect(10, 80, 51, 28), "JumperT20/left.png", act));
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(10, 120, 51, 28), "JumperT20/left.png", act));
  ...
  addRadioWidget(ui->rightbuttons->addArea(QRect(140, 60, 51, 71), "JumperT20/right.png", m_mouseMidClickAction));
