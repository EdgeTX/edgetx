...
AutoColorSelectButton::AutoColorSelectButton(QWidget * parent) :
...
AutoColorSelectButton::~AutoColorSelectButton()
{
}

void AutoColorSelectButton::setup(QColor color, QWidget * sampleWidget)
{
  m_color = color;
