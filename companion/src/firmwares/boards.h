...
inline bool IS_FLYSKY_PL20(Board::Type board)
{
  return (board == Board::BOARD_FLYSKY_PL20);
}
...
{
  return IS_FLYSKY_PL18(board) || IS_FLYSKY_PL18EV(board) || IS_FLYSKY_PL18U(board) || IS_FLYSKY_PL20(board);
}
