...
int OpenTxFirmware::getCapability(::Capability capability)
{
  switch (capability) {
    ...
    case HasAuxSerialMode:
      return IS_FAMILY_HORUS_OR_T16(board) || (IS_TARANIS_X9(board) && !IS_TARANIS_X9DP_2019(board));
    case HasAux2SerialMode:
      return IS_FAMILY_T16(board);
    case HasVCPSerialMode:
      return IS_FAMILY_HORUS_OR_T16(board) || IS_RADIOMASTER_ZORRO(board) || IS_JUMPER_TPRO(board);
    case HasBluetooth:
